%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
%%% Ejercicio Nro. 3 TP#FINAL M茅todos Num茅ricos
%%%
%%% Aproximaci贸n Lineal por M铆nimos Cuadrados:
%%%
%%%         y = Ax + B
%%%
...
set(F1,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3a TP#FINAL. M閠odos Num閞icos');
...
set(F2,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3b TP#FINAL. M閠odos Num閞icos');
plot(X,Y,'*r',x_eval,Y_AL_b, 'b') % Nube de puntos originales
xlabel('D [mm]')
ylabel('P(D) [mmHg]')
legend ('Pk', 'Aproximaci贸n exponencial Pk')
grid
...
set(F3,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3c TP#FINAL. M閠odos Num閞icos');
...
set(F4,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3d TP#FINAL. M閠odos Num閞icos');
...
set(F5,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3e TP#FINAL. M茅todos Num茅ricos');
hold on
plot(X,Y,'*r')
xlabel('D [mm]')
ylabel('P(D) [mmHg]')
...
set(F6,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3f (i) TP#FINAL. M閠odos Num閞icos');
...
set(F7,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3f (ii) TP#FINAL. M閠odos Num閞icos');
...
%iii.
[D,err,relerr,n] = Extrapolacion_Richardson_O2n(Y_AL_c,D_m,Delta,Tol);% referencia a esa funci贸n
F8=figure(8);
set(F8,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3f (iii) TP#FINAL. M閠odos Num閞icos');
...
%iv
[D,err,relerr,n] = Extrapolacion_Richardson_O2n(Y_AL_d,D_m,Delta,Tol);% referencia a esa funci贸n
F9=figure(9);
set(F9,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3f (iv) TP#FINAL. M閠odos Num閞icos');
...
%v
[D,err,relerr,n] = Extrapolacion_Richardson_O2n(Y_AL_e,D_m,Delta,Tol);% referencia a esa funci贸n
F10=figure(10);
set(F10,'position',[140 20 1100 650],'Menubar','none',...
        'NumberTitle','off','name', 'Ejercicio 3f (v) TP#FINAL. M閠odos Num閞icos');
